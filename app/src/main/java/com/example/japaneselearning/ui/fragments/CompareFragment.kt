...
class CompareFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        val audioManager = AudioManager(requireContext())
        recordingAdapter = RecordingAdapter(
            repository = repository, // Use the repository you already initialized in onViewCreated
    ...
    private fun deleteRecording(recording: Recording) {
        ...
        // Launch coroutine to delete the recording
